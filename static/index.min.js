(function() { /*! layer-v3.0.3 Web弹层组件 MIT License  http://layer.layui.com/  By 贤心 */
	!
	function(e, t) {
...
function search() {
	...
	var hotList = 0;
	var searchData = {
		"thisSearch": "https://www.dogedoge.com/results?q=",
		"thisSearchIcon": "url('/images/search_icon.png') -105px -175px",
		"hotStatus": true,
		"newwindow":true,
		"data": [
		{
		...
		{
			name: "秘迹",
			img: "url('https://www.dogedoge.com/assets/new_logo.min.png')", 
			position: "0px -280px",
	...
	$("#newwindow-btn").click(function() {
		$(this).toggleClass("off");
		searchData.newwindow = !searchData.newwindow;  
	});
	searchData.hotStatus ? $("#hot-btn").removeClass("off") : $("#hot-btn").addClass("off");
	searchData.newwindow ? $("#newwindow-btn").removeClass("off") : $("#newwindow-btn").addClass("off");
	...
	$("#search-btn").click(function() {
		...
		if(searchData.newwindow){
				window.open(searchData.thisSearch + textValue); 
		}
		else{
			location.href=searchData.thisSearch + textValue;
		}
			$("#box ul").html("")
		} else {
			layer.msg("请输入关键词！", {
...
var iconIndex;$(".top-item").hover(function(){iconIndex=$(this).index();if(iconIndex!==3){$(".top-item span").eq(iconIndex).show(150)}},function(){$(".top-item span").eq(iconIndex).hide(150)});